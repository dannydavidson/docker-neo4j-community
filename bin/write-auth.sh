...
# Lifted from https://github.com/artsince/docker-neo4j-auth/blob/master/build_auth_string.sh
# Lifted from https://github.com/tpires/neo4j/blob/master/build_auth_string.sh
